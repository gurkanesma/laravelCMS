...
<head>
    ...
    <!-- NProgress -->
    <link href="{{asset('CMS/vendors/nprogress/nprogress.css" rel=')}}" rel="stylesheet">
    <!-- Animate.css -->
        ...
        <div id="register" class="animate form login_form">
            <section class="login_content">
                {{Form::open(array('route'=>'register'))}}
                    ...
                    <div class="separator">
                        <p class="change_link">Zaten üye iseniz,
                            <a href="{{route('login')}}" class="to_register"> giriş yapın. </a>
                        </p>
